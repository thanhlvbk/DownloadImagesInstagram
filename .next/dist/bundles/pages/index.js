...
var pages_Index = function (_React$Component) {
  ...
  function Index(props) {
    ...
    _this.getImageFromUrl = function (value) {
      external__axios__default.a.get(window.location.href + 'get-image/' + value.split("/").toString()).then(function (response) {
        _this.setState({
          url: '',
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(
        ...
        image && external__react__default.a.createElement(
          external__react__default.a.Fragment,
          null,
          external__react__default.a.createElement('img', { src: image, className: 'jsx-1424380737' + ' ' + 'dii-image'
          }),
          external__react__default.a.createElement(
            components_Button,
